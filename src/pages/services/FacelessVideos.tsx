    ...
    <div className="min-h-screen bg-background osmo-bg">
      ...
      <main className="pt-24 relative z-10">
        <div className="container mx-auto px-6 py-12">
          ...
          {/* Faceless Video Showcase - Redesigned */}
          <motion.div 
            className="mb-24"
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                      <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <span>+215% Engagement</span>
                      </div>
                      <div className="text-sm font-semibold text-red-600">2.8M views</div>
                    </div>
                  </div>
                </Card>
              </motion.div>
                ...
                <Card className="bg-white border border-red-200 overflow-hidden group hover:shadow-xl transition-all duration-300">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                      ...
                      <div className="text-sm font-semibold text-red-600">4.1M views</div>
                    </div>
                  </div>
                </Card>
              </motion.div>
